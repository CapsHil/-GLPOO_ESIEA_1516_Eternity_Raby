...
public class TirageEuromillion {
	...
	private int boule1, boule2, boule3, boule4, boule5, etoile1, etoile2;
	
	public TirageEuromillion(int boule1, int boule2, int boule3, int boule4, int boule5, int etoile1, int etoile2){
		this.boule1 = boule1;
		this.boule2 = boule2;
		this.boule3 = boule3;
		this.boule4 = boule4;
